# ui — Galaxy Watch Stopwatch (LVGL)
...
├── project.xml              # LVGL Editor 프로젝트 메타
├── globals.xml              # LVGL Editor 전역 정의
├── user_config.cmake        # LVGL Editor 사용자 빌드 훅
├── components/              # LVGL Editor 컴포넌트 영역
├── fonts/                   # LVGL Editor 폰트 영역
├── images/                  # LVGL Editor 이미지 영역
├── screens/
│   ├── stopwatch_ui.h
│   └── stopwatch_ui.c       # 스톱워치 UI 와 상태 머신
└── widgets/                 # LVGL Editor 위젯 영역
```
